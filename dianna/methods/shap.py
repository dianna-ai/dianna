...
class KernelSHAP:
    ...
    def explain_image(
        ...
        input_data,
        nsamples="auto",
        background=None,  # pylint: disable=too-many-arguments
        n_segments=100,
        compactness=10.0,
        sigma=0,
        channel_axis=-1,
        **kwargs,
        ...
        Args:
            ...
            channel_axis (int): If None, the image is assumed to be a grayscale (single channel)
                                ...
                                array corresponds to channels. Channel_axis was added in version
                                0.19 of package scikit-image.
        ...
        with warnings.catch_warnings():
            ...
            shap_values = explainer.shap_values(
                np.ones((1, self.n_segments)), self.nsamples
            )

        return shap_values

    def _mask_image(
        self, features, segmentation, image, background=None, channel_axis=-1
    ):
