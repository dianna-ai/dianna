...
|*Tabular*|  [Land atmosphere dataset](https://zenodo.org/records/12623257)| developing a random forests regression algorithm to predict target variable "latent heat flux (LEtot)". The model will be used as an emulator to replace the physical model. | <img width="25" alt="Atmosphere Logo" src="https://github.com/user-attachments/assets/bee353dd-c19a-4aec-a778-4ca3574765f0"> |
